...
<span style="color: darkblue;">**Note: Environment 4 has  more than 20% missing, thus will be dropped from the downstream analysis.**</span>
...
* Heatmap of field designs for all the environments will be shown using heatmap using [**desplot**](https://github.com/kwstat/desplot) R package. 
...
```
<span style="color: darkblue;">**Some deviations are observed for the triats in certain environments.**</span>
</div>
...
* The R codes on this outlier function was orginally borrowed from the work available at [Click the link](https://static-content.springer.com/esm/art%3A10.1007%2Fs00122-016-2666-6/MediaObjects/122_2016_2666_MOESM2_ESM.pdf).
...
* * We will develope a function called ***my.blup*** which will be used to extract the reliability using the 
